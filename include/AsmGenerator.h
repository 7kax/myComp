...
namespace myComp {
    ...
    public:
        ...
        // Set the output file
        virtual void set_output(const std::string &filename) = 0;
        ...
        virtual void function_prelude(const std::string &name) = 0;

        // postlude of a function
        virtual void function_postlude(const std::string &name, int offset) = 0;
        ...
        virtual int widen_integer(int reg, DataType src, DataType dest) = 0;
        ...
        virtual int load_string(const std::string &label) = 0;
        ...
        // Move the stack pointer by a given amount to allocate space for local variables
        virtual void allocate_stack(int amount) = 0;

        // allocate a symbol
        virtual void allocate_global_symbol(const std::string &name) = 0;

        // allocate a string literal
        virtual void allocate_string_literal(const std::string &str, const std::string &label) = 0;

        // load a symbol's value into a register and return its number
        virtual int load_symbol(const std::string &name) = 0;

        // Store a register's value into a symbol
        virtual int store_symbol(int reg, const std::string &name) = 0;

        // Store a register's value into an address
        virtual int store_address(int address_reg, int val_reg, DataType data_type) = 0;

        // load a symbol's address into a register and return its number
        virtual int load_address(const std::string &name) = 0;

        // dereference a pointer and return its value
        virtual int dereference(int reg, DataType data_type) = 0;

        // dereference a pointer with an offset and return its value
        virtual int dereference(int address_reg, int offset_reg, DataType data_type) = 0;
        ...
        virtual int assign(const std::string &name, int reg) = 0;

        virtual int assign(int address_reg, int val_reg, DataType data_type) = 0;

        virtual int assign(int address_reg, int offset_reg, int val_reg, DataType data_type) = 0;
        ...
        virtual int pre_increment(const std::string &name) = 0;

        virtual int pre_decrement(const std::string &name) = 0;

        virtual int post_increment(const std::string &name) = 0;

        virtual int post_decrement(const std::string &name) = 0;
        ...
        virtual void jump_zero(int reg, const std::string &label) = 0;

        virtual void label(const std::string &label) = 0;

        virtual int call(const std::string &name) = 0;
